...
public class SQLiteContentProvider extends ContentProvider {
    ...
    private static final Map<String, SQLiteTableProvider> SCHEMA = new ConcurrentHashMap<String, SQLiteTableProvider>();
    static {
        SCHEMA.put(LocationsProvider.TABLE_NAME, new LocationsProvider());
        SCHEMA.put(WeatherProvider.TABLE_NAME, new WeatherProvider());
    }
    ...
    public Cursor query(Uri uri, String[] projection, String where,
        ...
        final Cursor cursor = tableProvider.query(mHelper.getReadableDatabase(), projection, where, whereArgs, orderBy);
