...
public class LocationsProvider extends SQLiteTableProvider{
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table if not exists " + TABLE_NAME +
                ...
                + Columns.CITY_COUNTRY + " text, "
                + Columns.CITY_LAT + " real, "
                + Columns.CITY_LON + " real, "
                + Columns.CITY_SUNRISE + " integer, "
                + Columns.CITY_SUNSET + " integer, "
                + Columns.CITY_TEMP + " real);");
        db.execSQL("insert into " +TABLE_NAME + " values (0, 524901, 'Moscow', 'RU',37.615555, 55.75222, null, null, null);");
        db.execSQL("insert into " +TABLE_NAME + " values (1, 498817, 'Saint Petersburg', 'RU', 30.306, 59.9332, null, null, null);");
    }
